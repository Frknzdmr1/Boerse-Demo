...
INSERT INTO benutzer (id, benutzername, email, passwort, kontotyp, erstellt_am, aktualisiert_am) VALUES
                                                                                                     (RANDOM_UUID(), 'user1', 'user1@example.com', '$2a$12$kbOQ3KrCR6Xx3HkfB/OHwOTmKoBmUGWZusagLSqxKkLmY1/RY7g5a', 'STANDARD', NOW(), NOW()),
...
INSERT INTO benutzer_rollen (benutzer_id, role_id) VALUES
                                                      ((SELECT id FROM benutzer WHERE benutzername = 'user1'), (SELECT id FROM rollen WHERE bezeichnung = 'USER')),
...
INSERT INTO portfolios (id, benutzer_id, erstellt_am, aktualisiert_am) VALUES
                                                                           (RANDOM_UUID(), (SELECT id FROM benutzer WHERE benutzername = 'user1'), NOW(), NOW()),
...
INSERT INTO portfolio_aktien (id, portfolio_id, aktie_id, menge, durchschnittlicher_kaufpreis) VALUES
                                                                                                   (RANDOM_UUID(), (SELECT id FROM portfolios WHERE benutzer_id = (SELECT id FROM benutzer WHERE benutzername = 'user1')), (SELECT id FROM aktien WHERE symbol = 'AAPL'), 10, 145.00),
...
INSERT INTO auftraege (id, benutzer_id, aktie_id, auftragstyp, menge, preis, status, erstellt_am, aktualisiert_am) VALUES
                                                                                                                       (RANDOM_UUID(), (SELECT id FROM benutzer WHERE benutzername = 'user1'), (SELECT id FROM aktien WHERE symbol = 'AAPL'), 'KAUF', 10, 145.00, 'ABGESCHLOSSEN', NOW(), NOW()),
...
INSERT INTO transaktionen (id, auftrag_id, benutzer_id, aktie_id, transaktionstyp, menge, preis, zeitstempel) VALUES
                                                                                                                  (RANDOM_UUID(), (SELECT id FROM auftraege WHERE benutzer_id = (SELECT id FROM benutzer WHERE benutzername = 'user1') AND aktie_id = (SELECT id FROM aktien WHERE symbol = 'AAPL')), (SELECT id FROM benutzer WHERE benutzername = 'user1'), (SELECT id FROM aktien WHERE symbol = 'AAPL'), 'KAUF', 10, 145.00, NOW()),
...
INSERT INTO beobachtungslisten (id, benutzer_id, name, erstellt_am, aktualisiert_am) VALUES
                                                                                         (RANDOM_UUID(), (SELECT id FROM benutzer WHERE benutzername = 'user1'), 'Tech Stocks', NOW(), NOW()),
