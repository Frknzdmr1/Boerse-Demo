...
import {variantsChat} from "@/mocks/learnings";
...
const Learnings = () => {
    ...
    return (
        ...
        >
            <div
                className="flex mt-8 overflow-auto scrollbar-none scroll-smooth -mx-6 before:shrink-0 before:w-6 after:shrink-0 after:w-6 md:mt-6 md:-mx-4 md:before:w-4 md:after:w-4">
                {variantsChat.map((variant: { id: any; url: any; title: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | null | undefined; content: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | null | undefined; icon: string; }) => (
                    <Link
